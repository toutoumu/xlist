...
class AppConfigSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: AppConfig?) {
    let isWakeLockEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.AppConfig.isWakeLockEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setWakeLockEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.AppConfig.setWakeLockEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let isStartAtBootEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.AppConfig.isStartAtBootEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setStartAtBootEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.AppConfig.setStartAtBootEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let isAutoCheckUpdateEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.AppConfig.isAutoCheckUpdateEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setAutoCheckUpdateEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.AppConfig.setAutoCheckUpdateEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let isAutoOpenWebPageEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.AppConfig.isAutoOpenWebPageEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setAutoOpenWebPageEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.AppConfig.setAutoOpenWebPageEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let getDataDirChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.AppConfig.getDataDir", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setDataDirChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.AppConfig.setDataDir", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let isSilentJumpAppEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.AppConfig.isSilentJumpAppEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setSilentJumpAppEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.AppConfig.setSilentJumpAppEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
...
class NativeCommonSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: NativeCommon?) {
    let startActivityFromUriChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.NativeCommon.startActivityFromUri", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let getDeviceSdkIntChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.NativeCommon.getDeviceSdkInt", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let getDeviceCPUABIChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.NativeCommon.getDeviceCPUABI", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let getVersionNameChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.NativeCommon.getVersionName", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let getVersionCodeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.NativeCommon.getVersionCode", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let toastChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.NativeCommon.toast", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let longToastChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.NativeCommon.longToast", binaryMessenger: binaryMessenger)
    if let api = api {
...
class AndroidSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: Android?) {
    let addShortcutChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.Android.addShortcut", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let startServiceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.Android.startService", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setAdminPwdChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.Android.setAdminPwd", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let getAdminPasswordChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.Android.getAdminPassword", binaryMessenger: binaryMessenger)
    if let api = api {
      getAdminPasswordChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getAdminPassword()
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getAdminPasswordChannel.setMessageHandler(nil)
    }
    let getAdminUsernameChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.Android.getAdminUsername", binaryMessenger: binaryMessenger)
    if let api = api {
      getAdminUsernameChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getAdminUsername()
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getAdminUsernameChannel.setMessageHandler(nil)
    }
    let getOutboundIPStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.Android.getOutboundIPString", binaryMessenger: binaryMessenger)
    if let api = api {
      getOutboundIPStringChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getOutboundIPString()
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getOutboundIPStringChannel.setMessageHandler(nil)
    }
    let getAListHttpPortChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.Android.getAListHttpPort", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let isRunningChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.Android.isRunning", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let getAListVersionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xlist.Android.getAListVersion", binaryMessenger: binaryMessenger)
    if let api = api {
...
class Event: EventProtocol {
  ...
  func onServerLog(level levelArg: Int64, time timeArg: String, log logArg: String, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.xlist.Event.onServerLog"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger)
