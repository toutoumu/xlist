...
//
//   // 自动播放
//   final isAutoPlay = Get
//       .find<PreferencesStorage>()
//       .isAutoPlay
//       .val;
//
//   // 后台播放
//   final isBackgroundPlay = Get
//       .find<PreferencesStorage>()
//       .isBackgroundPlay
//       .val;
//
...
//       final _timedTextTracks = <Map<String, String>>[];
//       final _audioTracks = <Map<String, String>>[];
//       event.subtitle.asMap().forEach((index, element) {
//         _timedTextTracks.add({
//           'index': index.toString(),
//           'title': CommonUtils.formatIjkTrack(element.title ?? ""),
//           'language': element.language ?? "--",
//           'info': element.codec ?? "",
//         });
//       });
//
//       event.audio.asMap().forEach((index, element) {
//         _audioTracks.add({
//           'index': index.toString(),
//           'title': CommonUtils.formatIjkTrack(element.title ?? ""),
//           'language': element.language ?? "--",
